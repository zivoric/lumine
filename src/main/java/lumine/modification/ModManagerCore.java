...
import lumine.modification.config.ModConfiguration;
...
public class ModManagerCore {
    ...
    private void initInstance() {
        ...
        File minecraftDir = LumineConstants.instance().MINECRAFT_DIRECTORY;
        File[] fileArray = null;
        ...
        for (File file : folderContents) {
            try {
                ...
                Lumine.LOGGER.error("Exception in loading of mod " + file.getName(), mle);
            }
        }
        ...
        for (ModWrapper mod : mods) {
            if (!mod.isMainPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Exception while preparing mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion(), e);
                }
                Lumine.log("Successfully prepared mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : mods) {
            if (!mod.isClientPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Exception while preparing client mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion(), e);
                }
                Lumine.log("Successfully prepared client mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : mods) {
            if (!mod.isServerPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Exception while preparing server mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion(), e);
                }
                Lumine.log("Successfully prepared server mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : mods) {
            if (mod.isMainPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Error while initializing mod " + mod.getMainClass().getName(), ModRuntimeException.create(e));
                }
                Lumine.log("Successfully initialized mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : mods) {
            if (mod.isClientPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Error while initializing client mod " + mod.getClientClass().getName(), ModRuntimeException.create(e));
                }
                Lumine.log("Successfully initialized client mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : mods) {
            if (mod.isServerPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Error while initializing server mod " + mod.getClientClass().getName(), ModRuntimeException.create(e));
                }
                Lumine.log("Successfully initialized server mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : reversed) {
            if (mod.isServerPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Error while terminating server mod " + mod.getMainClass().getName(), ModRuntimeException.create(e));
                }
                Lumine.log("Successfully terminated server mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
        ...
        for (ModWrapper mod : reversed) {
            if (mod.isMainPrepared()) {
                try {
                    ...
                    Lumine.LOGGER.error("Error while terminating mod " + mod.getMainClass().getName(), ModRuntimeException.create(e));
                }
                Lumine.log("Successfully terminated mod " + mod.getConfig().getValues().getName() + " v" + mod.getConfig().getValues().getVersion());
            }
        }
    }
