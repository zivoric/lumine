...
public class RefractionVisitor extends ClassVisitor {
    private final ClassRefractor refractor;
    public RefractionVisitor(ClassVisitor classVisitor, ClassRefractor refractor) {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        for (MethodWrapper wrapper : refractor.getInjectorMethods()) {
            if (name.equals(wrapper.name()) && desc.equals(wrapper.desc())) {
    ...
    private InsnList invokeInsns(MethodInjector injector, MethodInjector.InjectorInfo pair, boolean isStatic, boolean cacheValue, boolean passInstance) {
        ...
        InsnList list = new InsnList() {{
            ...
            add(new MethodInsnNode(Opcodes.INVOKESTATIC, "lumine/prisma/refract/ClassRefractor", "invoke", "(Ljava/lang/String;Ljava/lang/String;Z[Ljava/lang/Object;)Ljava/lang/Object;"));
        }};
        return list;
    }
