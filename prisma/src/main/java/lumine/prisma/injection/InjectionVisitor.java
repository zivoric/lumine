...
import lumine.prisma.injection.annotations.ReturnInjection;
import lumine.prisma.injection.util.InjectProperties;
import lumine.prisma.injection.util.InjectionUtils;
import lumine.prisma.injection.util.MethodInfo;
import lumine.prisma.injection.visitor.ReturnInvokeAdapter;
import lumine.prisma.injection.visitor.StartInvokeAdapter;
...
public class InjectionVisitor extends ClassVisitor {
    ...
    private InsnList invokeInsns(MethodInjector injector, MethodInjector.InjectorInfo pair, boolean isStatic, boolean cacheValue, boolean passInstance) {
        ...
        InsnList list = new InsnList() {{
            ...
            add(new MethodInsnNode(Opcodes.INVOKESTATIC, "lumine/prisma/injection/ClassInjector", "invoke", "(Ljava/lang/String;Ljava/lang/String;Z[Ljava/lang/Object;)Ljava/lang/Object;"));
        }};
        return list;
    }
