...
import conduit.prisma.injection.util.InjectionUtils;
...
public class InjectionVisitor extends ClassVisitor {
    ...
    private InsnList invokeInsns(MethodInjector injector, MethodInjector.InjectorInfo pair, boolean isStatic, boolean cacheValue, boolean passInstance) {
        ...
        InsnList list = new InsnList() {{
            ...
            add(new MethodInsnNode(Opcodes.INVOKESTATIC, "conduit/prisma/injection/ClassInjector", "invoke", "(Ljava/lang/String;Ljava/lang/String;Z[Ljava/lang/Object;)Ljava/lang/Object;"));
        }};
        return list;
    }
